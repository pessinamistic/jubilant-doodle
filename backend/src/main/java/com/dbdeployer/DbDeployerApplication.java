...
public class DbDeployerApplication {
    ...
    private static final Map<String, String> LEGACY_TZ_ALIASES = Map.of(
    ...
    private static void normalizeLegacyTimezoneAlias() {
        ...
        if (!normalizedTz.equals(currentTz)) {
            ...
            log.info("Normalized JVM timezone from {} to {} for PostgreSQL compatibility",
                    currentTz, normalizedTz);
        }
    }
}
