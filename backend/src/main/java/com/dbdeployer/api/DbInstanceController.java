...
public class DbInstanceController {
  ...
  @PostMapping("")
  public ResponseEntity<InstanceResponse> deploy(@Valid @RequestBody ConfigTemplateRequest req) {
    log.info(
    ...
    DeploymentResponse deploymentResponse = service.deploy(req, deploymentConfig, false);
    deploymentConfig = deploymentResponse.getDeploymentConfig();
    log.info(
        "[api] deploy accepted: configId={}, name='{}'",
