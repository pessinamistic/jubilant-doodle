...
public record ContainerMetricsResponse(
    ...
    public static ContainerMetricsResponse unavailable() {
        return new ContainerMetricsResponse(
                ...
                0, 0, 0, 0,
                0, 0,
                0, null, "stopped", "none", false, null, 0,
                false, -1,
                Map.of());
    }
    ...
    public ContainerMetricsResponse withToolMetrics(Map<String, Object> tools) {
        return new ContainerMetricsResponse(
                available,
                cpuPercent, cpuCores, cpuThrottledPercent,
                memUsageBytes, memMaxUsageBytes, memLimitBytes, memPercent,
                netRxBytes, netTxBytes, netRxPackets, netTxPackets, netRxErrors, netTxErrors,
                blockReadBytes, blockWriteBytes, blockReadOps, blockWriteOps,
                pids, pidsLimit,
                restartCount, image, containerState, healthStatus, oomKilled, startedAt, uptimeSeconds,
