...
public record ConfigTemplateResponse(String id, String name, String description, DbType dbType, String dbTypeDisplay,
  ...
  public static ConfigTemplateResponse from(
    ...
    return new ConfigTemplateResponse(t.getId(), t.getName(), t.getDescription(), t.getDbType(), display, icon,
        t.getVersion(), t.getHostPort(), t.getUsername(), t.getPassword(), t.getDatabaseName(), t.getExtraEnvJson(),
        t.getDeployCount(), t.getCreatedAt(), t.getUpdatedAt());
  }
}
