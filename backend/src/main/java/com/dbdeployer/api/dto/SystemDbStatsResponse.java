...
/**
 * Rich stats snapshot for the Port Wrangler system (Postgres) database. Returned by {@code GET
 * /api/system/stats}.
 */
public record SystemDbStatsResponse(
    DbInfo db, SchemaInfo schema, PoolInfo pool, AppInfo app, JvmInfo jvm) {

  public record DbInfo(
      String type, String version, String host, int port, String databaseName, long dbSizeBytes) {}
