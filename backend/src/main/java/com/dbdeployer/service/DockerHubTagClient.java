...
public class DockerHubTagClient {
    ...
    public HubTagResult checkTag(String image, String tag) {
        ...
        String url = "https://hub.docker.com/v2/namespaces/" + namespace
                + "/repositories/" + repository + "/tags/" + safeTag;
        ...
        try {
            ...
            return new HubTagResult(
                    ...
                    "Docker Hub check returned HTTP " + status
            );
            ...
            return new HubTagResult(
                    ImageAvailabilityState.UNKNOWN,
                    "Docker Hub check failed: " + e.getMessage()
            );
        }
    }

    /**
     * Converts a Docker image name into Docker Hub namespace/repository if applicable.
