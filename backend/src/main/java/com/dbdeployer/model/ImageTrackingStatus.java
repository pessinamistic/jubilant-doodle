...
public class ImageTrackingStatus {
    ...
    public boolean isDockerHubManaged() { return dockerHubManaged; }
    public void setDockerHubManaged(boolean dockerHubManaged) { this.dockerHubManaged = dockerHubManaged; }

    public ImageAvailabilityState getLocalStatus() { return localStatus; }
    public void setLocalStatus(ImageAvailabilityState localStatus) { this.localStatus = localStatus; }

    public ImageAvailabilityState getDockerHubStatus() { return dockerHubStatus; }
    public void setDockerHubStatus(ImageAvailabilityState dockerHubStatus) { this.dockerHubStatus = dockerHubStatus; }

    public ImageValidationDecision getDecision() { return decision; }
    public void setDecision(ImageValidationDecision decision) { this.decision = decision; }

    public String getMessage() { return message; }
    public void setMessage(String message) { this.message = message; }

    public LocalDateTime getLocalCheckedAt() { return localCheckedAt; }
    public void setLocalCheckedAt(LocalDateTime localCheckedAt) { this.localCheckedAt = localCheckedAt; }

    public LocalDateTime getDockerHubCheckedAt() { return dockerHubCheckedAt; }
    public void setDockerHubCheckedAt(LocalDateTime dockerHubCheckedAt) { this.dockerHubCheckedAt = dockerHubCheckedAt; }
