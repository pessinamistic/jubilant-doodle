...
public class AppConfig implements WebMvcConfigurer {
     ...
     * dbdeployer.cors.allowed-origins} in application.yml or the
     * {@code DBDEPLOYER_CORS_ORIGINS} environment variable.
     *
     * <p>
     * When the app is containerised, the frontend is served from the same Spring
     * Boot origin so CORS is not needed for the UI. The env var exists for
     * development (Vite on 5173) and any edge case where the UI is served from a
     * different host.
     */
