 ...
 * @param toolCalling true when the model has reliable native function/tool-calling support — drives
 *     the Model Cookbook's "Tools" filter for agentic use cases. Conservative: models with only
 *     "partial"/"weak"/"indirect" tool support upstream are marked {@code false}.
 */
