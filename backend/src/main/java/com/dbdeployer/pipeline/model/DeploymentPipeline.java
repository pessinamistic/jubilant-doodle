 ...
 *
 * <p>A new pipeline is created each time a deploy is triggered. The relationship to {@code
 * DeploymentConfig} is denormalised as a plain String {@code configId} so that pipeline rows remain
