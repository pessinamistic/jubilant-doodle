...
/**
 * Thrown by a {@link DeployStep} implementation when it encounters a known
 * Docker failure. Carries a {@link DeployErrorCode} so the pipeline runner can
 * record a structured error code alongside the human-readable message.
 */
